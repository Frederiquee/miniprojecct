...
label = Label(master=hoofd_frame, text='Welkom in fietsenstalling ! \n Nog niet geregistreerd? Registreer u dan eerst!', font=('Helvetica', 15, 'bold'), height=3, background='yellow')
label.pack()
...
label = Label(master=stallen_frame, text='Voer hier uw naam in:', background='yellow', font=('Helvetica', 10, 'bold'))
label.pack(fill=X, padx=20)
entryST = Entry(master=stallen_frame)
entryST.pack(padx=20, pady=20)
label2 = Label(master=stallen_frame, text='Voer hier uw nummer in:', background='yellow', font=('Helvetica', 10, 'bold'))
